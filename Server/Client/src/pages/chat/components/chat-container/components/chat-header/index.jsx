          ...
          <div className='h-12 w-12 relative'>
            {
              ...
              />) : (
                <div className={`uppercase h-12 w-12 text-5xl border-[1px] flex items-center justify-center rounded-full ${getColor(selectedChatData?.color)}`}>
            ...
            </Avatar> : <div className="bg-[#ffffff22] w-10 h-10 rounded-full flex justify-center items-center">#</div>
            }
