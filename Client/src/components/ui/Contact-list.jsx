            ...
            {contacts.map((contact) => (
                ...
                >
                    <div className="flex gap-5 items-center justify-start text-neutral-300">
                                ...
                                {contact.image ? (
                                    ...
                                    <div
                                        ...
                                        ${selectedChatData && selectedChatData._id === contact._id ? "bg-[#ffffff22] border-white/70" : getColor(contact.color)}
                                            uppercase h-10 w-10 text-5xl border-[1px] flex items-center justify-center rounded-full`}
                                    >
                                        {contact.firstName
                        ...
                        {
                            isChannel && <div className="bg-[#ffffff22] w-10 h-10 rounded-full flex justify-center items-center">#</div>
                        }
